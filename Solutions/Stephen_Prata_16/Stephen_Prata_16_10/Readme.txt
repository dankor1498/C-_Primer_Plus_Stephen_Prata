...
shared ptr должен быть инициализирован указателем, возвращенным операцией new.
...
введенных данных создайте еще один вектор указателей shared ptr,
...
второго вектора так, чтобы shared ptr были упорядочены по названиям 
книг, сохраненных в указанных объектах. Повторите процесс, чтобы 
получить вектор объектов shared ptr, отсортированных по rating и 
price. Обратите внимание, что rbegin() и rend() избавляют от 
необходимости создания векторов с обратным порядком следования элементов.